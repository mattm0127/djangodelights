...
LOGIN_REDIRECT_URL = '/ingredients' # will redirect users to Menu Items from login view (LoginView)
LOGOUT_REDIRECT_URL = '/' # will redirect users to home from logout view (LogoutView)
